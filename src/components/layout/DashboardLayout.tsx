  ...
  const getNavigationItems = () => {
    ...
    const roleSpecificItems = {
      ...
      school: [
        ...
        { name: 'Attendance', href: '/dashboard/school/attendance', icon: 'check-square' },
        { name: 'Incidents', href: '/dashboard/school/incidents', icon: 'alert-circle' },
      ],
      authority: [
      ...
      community: [
        ...
        { name: 'Safety Map', href: '/dashboard/community/map', icon: 'map' },
      ],
      admin: [
        { name: 'Users', href: '/dashboard/admin/users', icon: 'users' },
        { name: 'Alerts', href: '/dashboard/admin/alerts', icon: 'alert-triangle' },
        { name: 'Analytics', href: '/dashboard/admin/analytics', icon: 'bar-chart' },
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 px-2 space-y-1">
              {navigationItems.map((item) => (
                ...
                >
                  <div className="mr-4 flex-shrink-0 text-gray-500">{Icon({ name: item.icon })}</div>
                  {item.name}
                </Link>
              ))}
            </nav>
          ...
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 px-2 space-y-1">
              {navigationItems.map((item) => (
                ...
                >
                  <div className="mr-3 flex-shrink-0 text-gray-500">{Icon({ name: item.icon })}</div>
                  {item.name}
                </Link>
              ))}
            </nav>
