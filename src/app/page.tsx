  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1>Protecting Children Through Technology</h1>
              <p>UNCIP connects parents, schools, and authorities to create a safer environment for children in South African townships.</p>
        ...
        <div className="container">
          ...
          <div className="feature-grid">
            ...
            <div className="feature-card">
              ...
              <h3 className="feature-title">Instant Identification</h3>
      ...
      <section className="cta">
        <div className="container">
          <h2>Join the UNCIP Network Today</h2>
          <p>Be part of the solution to create safer communities for children across South Africa.</p>
          <Link href="/auth/register" className="btn btn-primary">Register Now</Link>
        </div>
      </section>
